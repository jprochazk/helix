...
| `indent-style` | Default indentation style used when it cannot be auto-detected from the file contents and the language defines no indentation. Accepts the same values as the `:indent-style` command: `"tabs"` or a number of spaces (1-16). | `"tabs"` |
